Ext.define('myapp.controller.reportes.Criinfempresa', {
    ...
    onButtonClickejecutar: function (button, e, options) {
        ...
        cmbrama = formPanel.down("combobox[name=cmbrama]").getValue();
        cmbformatoReporte = formPanel.down("combobox[name=formatoReporte]").getRawValue();
        window.open(BASE_URL + 'pdfs/infpersonal/listadopersonal?rif=' + rif + '&rif1=' + rif1 + '&rif2=' + rif2 + '&nombrecomer=' + nombrecomer + '&anoact=' + anoact + '&cmbmunicipio=' + cmbmunicipio + '&cmbparroquia=' + cmbparroquia + '&cmbcomunidad=' + cmbcomunidad + '&cmbtipo=' + cmbtipo + '&cmbdivision=' + cmbdivision + '&cmbseccion=' + cmbseccion + '&cmbgrupo=' + cmbgrupo + '&cmbclase=' + cmbclase + '&cmbrama=' + cmbrama + '&cmbformatoReporte=' + cmbformatoReporte);
    },
