...
class Infpersonal extends CI_Controller {
    ...
    public function listadopersonal(){
        ...
        $resultado = $this->infpersonal_model->getinfpersonal($rifs,$nombrecomer,$anoact,$cmbmunicipio,$cmbparroquia,$cmbcomunidad,$cmbtipo,$cmbseccion,$cmbdivision,$cmbgrupo,$cmbclase); 
        if($resultado){
            $html = " ";
